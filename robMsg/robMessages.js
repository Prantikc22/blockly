...
Blockly.Msg.MENU_SHORTCUT_IMPORT = 'Ctrl + I: Import program';	
Blockly.Msg.MENU_SHORTCUT_EXPORT = 'Ctrl + E: Export program';	
Blockly.Msg.MENU_SHORTCUT_SAVE = 'Ctrl + S: Save';	
Blockly.Msg.MENU_SHORTCUT_SAVEAS = 'Ctrl + Shift + S: Save As';	
Blockly.Msg.MENU_SHORTCUT_RUN = 'Ctrl + R: Run on robot';	
Blockly.Msg.MENU_SHORTCUT_SOURCE_CODE = 'Ctrl + Z: Open/Close source code view';	
Blockly.Msg.MENU_SHORTCUT_EDITOR = 'Ctrl + Shift + Z: Open source code editor';	
Blockly.Msg.MENU_SHORTCUT_MULTISIM = 'Ctrl + Shift + G: Multiple robot simulation';	
Blockly.Msg.MENU_SHORTCUT_OPEN_SIM = 'Ctrl + G: Open/Close simulation view';	
Blockly.Msg.MENU_SHORTCUT_VIEW_PROGRAM = 'Ctrl + M: My programs';
