...
Blockly.Msg.MENU_SHORTCUT_EDITOR = "Shift + Z: Show the source code editor";
Blockly.Msg.MENU_SHORTCUT_EXPORT = "Ctrl + E: Export the program";
Blockly.Msg.MENU_SHORTCUT_IMPORT = "Ctrl + I: Import the program";
Blockly.Msg.MENU_SHORTCUT_MULTISIM = "Shift + G: Multiple robot simulation";
Blockly.Msg.MENU_SHORTCUT_OPEN_SIM = "Ctrl + G: Open the simulation window";
Blockly.Msg.MENU_SHORTCUT_RUN = "Ctrl + R: Run the program";
Blockly.Msg.MENU_SHORTCUT_SAVE = "Ctrl + S: Save the program in the database on server";
Blockly.Msg.MENU_SHORTCUT_SAVEAS = "Shift + S: Save the program or configuration in the server with a new name";
Blockly.Msg.MENU_SHORTCUT_SOURCE_CODE = "Ctrl + Z: Show the source code";
Blockly.Msg.MENU_SHORTCUT_VIEW_PROGRAM = "Ctrl + M: Viewing all programs";
